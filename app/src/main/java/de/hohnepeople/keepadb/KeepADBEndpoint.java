...
final class KeepADBEndpoint {
    ...
    //  - QUICK_PROBE_CANDIDATE_TIMEOUT_MS (150ms, below): the opportunistic local port-range
    ...
    // #412: same budget class as QUICK_PROBE_CANDIDATE_TIMEOUT_MS above, sized for a single
